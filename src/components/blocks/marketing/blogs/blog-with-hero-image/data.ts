export const posts = [
    ...
    },
    {
        ...
        readTime: "3 min",
        excerpt: "Understand the importance of user experience in digital products and how it affects customer satisfaction and retention.",
        image: "https://images.unsplash.com/photo-1586717791821-3f44a5638d0f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
        category: "Design",
        publishedAt: "March 15, 2023",
        author: {
            name: "Bob Brown",
            avatarUrl: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=60",
        },
    },
]
