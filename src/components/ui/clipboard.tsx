...
export const ClipboardTrigger = ChakraClipboard.Trigger
export const ClipboardIndicator = ChakraClipboard.Indicator

export const Clipboard = {
  Root: ClipboardRoot,
  Trigger: ClipboardTrigger,
  Indicator: ClipboardIndicator,
  Input: ChakraClipboard.Input,
  Label: ChakraClipboard.Label,
}
